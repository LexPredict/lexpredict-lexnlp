...
def get_regulations(text, return_source=False, as_dict=False):
    """
    Get regulations.
    :param text:
    :param return_source:
    ...
    if as_dict:
        keys = ['regulation_type', 'regulation_code', 'regulation_str']
        result = [{keys[n]: val for n, val in enumerate(item)} for item in result]

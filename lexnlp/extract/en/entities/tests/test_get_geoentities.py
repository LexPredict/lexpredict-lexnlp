...
from lexnlp.extract.en.geoentities import load_entities_dict_by_path, get_geoentity_annotations
...
class TestGetGeoEntities(TestCase):
    def test_get_geo(self):
        ...
        geos = list(get_geoentity_annotations(
            text,
            _CONFIG))
